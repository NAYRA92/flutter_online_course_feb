...
class _RHomeScreenState extends State<RHomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: SingleChildScrollView( //to make anything scrollable!..
          child: Padding(
            padding: const EdgeInsets.all(10.0),
            child: Column(
              children: [
                SizedBox(height: 30,),
                Image.asset("images/r_color_logo.png",
                height: 30.8,
                ),
                Row(
                ...
                Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                     myListViewContainer("images/apple.png", "Red Apple", "1kg, Priceg", "4.99"),
                     myListViewContainer("images/banana.png", "Organic Bananas", "7pcs, Priceg", "3.00"),
                     myListViewContainer("images/apple.png", "Red Apple", "1kg, Priceg", "4.99"),
                    ],
                  ),
                ),
